...
PYBIND11_MODULE(calculate_distances, m) {
	...
	.def("check_box", py::overload_cast<const SPos&, double>(&SPos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'max'", "other"_a, "max"_a)
	.def("check_box", py::overload_cast<const SPos&, const BinSpecifier&>(&SPos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'binner.bin_max'", "other"_a, "binner"_a)
    ...
    .def("check_box", py::overload_cast<const SPos&, double>(&Pos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'max', using the observed position in self if set", "other"_a, "max"_a)
    .def("check_box", py::overload_cast<const SPos&, const BinSpecifier&>(&Pos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'binner.bin_max', using the observed position in self if set", "other"_a, "binner"_a)
    .def("check_box", py::overload_cast<const Pos&, double>(&Pos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'max', using the observed positions if set in self and other", "other"_a, "max"_a)
    .def("check_box", py::overload_cast<const Pos&, const BinSpecifier&>(&Pos::check_box, py::const_), "Check whether all components of the separation are within a box of side length 'binner.bin_max', using the observed positions if set in self and other", "other"_a, "binner"_a)
